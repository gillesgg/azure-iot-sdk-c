...
static IOTHUB_MODULE_CLIENT_METHOD_HANDLE TEST_MODULE_CLIENT_METHOD_HANDLE = (IOTHUB_MODULE_CLIENT_METHOD_HANDLE)0x000A;
...
static IOTHUB_MODULE_CLIENT_LL_HANDLE_DATA TEST_IOTHUB_MODULE_CLIENT_LL_HANDLE_DATA = { (IOTHUB_CLIENT_CORE_LL_HANDLE)0x0001,(IOTHUB_MODULE_CLIENT_METHOD_HANDLE)0x000A };
...
TEST_SUITE_INITIALIZE(suite_init)
{
    ...
    REGISTER_GLOBAL_MOCK_RETURN(IoTHubClientCore_LL_GetMethodHandle, TEST_MODULE_CLIENT_METHOD_HANDLE);
}
